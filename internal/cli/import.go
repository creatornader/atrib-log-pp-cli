...
but do not stop the import.`,
  ...
  atrib-log-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  atrib-log-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | atrib-log-pp-cli import <resource> --input -`,
