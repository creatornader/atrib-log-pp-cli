...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "atrib-log-pp-cli",
		Short: "Manage atrib-log resources via the atrib-log API",
		Long: `Manage atrib-log resources via the atrib-log API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'atrib-log-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("atrib-log-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'atrib-log-pp-cli profile list')")
	...
	rootCmd.AddCommand(newTileCmd(flags))
	...
	rootCmd.AddCommand(newByContextPromotedCmd(flags))
