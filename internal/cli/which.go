...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  atrib-log-pp-cli which "stale tickets"
  atrib-log-pp-cli which "bottleneck"
  atrib-log-pp-cli which --limit 1 "send message"
  atrib-log-pp-cli which                                # list the full capability index`,
